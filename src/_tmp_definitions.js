const tmpState = [
  {
    ...
    phonetics: [
      {
        text: '/skuːl/',
        audio:
          'https://api.dictionaryapi.dev/media/pronunciations/en/school-uk.mp3',
        sourceUrl: 'https://commons.wikimedia.org/w/index.php?curid=9027379',
        license: {
          name: 'BY 3.0 US',
    ...
    sourceUrls: ['https://en.wiktionary.org/wiki/school'],
  },
  {
    word: 'school',
    phonetic: '/skuːl/',
    ...
    meanings: [
      {
        ...
        definitions: [
          ...
          {
            definition: 'At Eton College, a period or session of teaching.',
            example:
          ...
          {
            definition: 'An art movement, a community of artists.',
            example:
